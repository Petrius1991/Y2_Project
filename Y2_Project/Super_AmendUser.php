 ...
 <title> Amend User </title>
	...
	<script>
		function ErrorScript(){
			alert("User access must be set to User, Admin or SuperUser (case sensitive)");
...
<tr>
<th>Username</th><th>Password</th><th>Forename</th><th>Middle Name</th><th>Surname</th><th>Gender</th><th>Access Level</th>
</tr>
						   ...
						   if(!mysqli_select_db($connect, $database))
						   {
							...
							exit();
							   ...
							   if(isset($_POST['id'])){
									...
									$updateaccess = $_POST['Access'];
									
									$updatesql = "UPDATE tbl_users SET userName='$_POST[Username]', userPass='$_POST[Password]', forename='$_POST[Forname]', midname='$_POST[Middlename]', surname='$_POST[Surname]', gender='$_POST[Gender]', accessLevel='$_POST[Access]' WHERE userID='$_POST[id]'";
							   ...
							   //end of updates
								...
								while($row = mysqli_fetch_array($result)){
									...
									echo"
									<tr><form name='update' action='./Super_AmendUser.php'  method='post'>
									...
									<td><input type='text' name='Access' id='Access' size='5' value='".$row[7]."' /></td>
